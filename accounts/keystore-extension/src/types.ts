import type {AccountStoreExtension, AccountStoreOptions, AccountStoreState} from "@algorandfoundation/accounts-store";
 ...
 */
export interface AccountsKeystoreExtensionOptions extends ExtensionOptions, AccountStoreOptions, KeyStoreOptions {
	accounts: {
